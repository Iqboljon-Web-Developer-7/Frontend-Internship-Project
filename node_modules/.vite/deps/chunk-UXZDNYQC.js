...
var PropsContext = React23.createContext(void 0);
...
function useCurrentColorScheme(options) {
  ...
  const [, setHasMounted] = React26.useState(false);
  ...
  const handleMediaQuery = React26.useCallback((event) => {
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => React27.useContext(ColorSchemeContext) || defaultContext;
  function CssVarsProvider(props) {
    ...
    const initialTheme = React27.useMemo(() => {
      if (themeProp) {
        return themeProp;
      }
    ...
    const allColorSchemes = React27.useMemo(() => joinedColorSchemes.split(","), [joinedColorSchemes]);
    ...
    const element = (0, import_jsx_runtime10.jsxs)(React27.Fragment, {
  ...
  const Grid2 = React29.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime12.jsx)(GridRoot, {
      ...
      children: React29.Children.map(children, (child) => {
        var _a;
        if (React29.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UXZDNYQC.js.map
